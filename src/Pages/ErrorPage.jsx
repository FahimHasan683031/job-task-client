...
const ErrorPage = () => {
    return (
        <div>
            <Header/>
            <main className="h-screen w-full flex flex-col justify-center items-center bg-sky-200">
                <h1 className="text-9xl font-extrabold text-sky-600 tracking-widest">404</h1>
                ...
                <button className="mt-5">
                    ...
                    >
                        ...
                        <span className="relative block px-8 py-3 bg-sky-600 border border-current">
